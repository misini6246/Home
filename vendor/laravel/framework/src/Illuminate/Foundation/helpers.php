...
if (! function_exists('asset')) {
    ...
    {
        if(strpos($path,'common.js')!==false||strpos($path,'flow_cart.js')!==false||
            strpos($path,'submit_order.js')!==false||strpos($path,'keywordsSearch.js')!==false||
            strpos($path,'goods_list.js')!==false||strpos($path,'index.js')!==false||strpos($path,'shopping_flow.js')!==false||strpos($path,'.js')) {
            return app('url')->asset($path, $secure).'?20160701';
        }else {
