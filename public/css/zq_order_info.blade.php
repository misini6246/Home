...
@section('links')
    ...
    <link href="{{asset('/css/confirm_order.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('/css/order_msg.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('/css/submit_order.css')}}" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="{{asset('/js/slides.jquery.js')}}"></script>
    <script type="text/javascript" src="{{asset('/js/my_com.js')}}"></script>
    <script type="text/javascript" src="{{asset('/js/my_order.js')}}"></script>
    <script type="text/javascript" src="{{asset('/js/submit_order.js')}}"></script>
    <script type="text/javascript" src="{{asset('/js/purchase.js')}}"></script>
    <script type="text/javascript" src="{{asset('/js/kf_top.js')}}"></script>
@endsection
@section('content')
    ...
    @include('layout.page_footer_user')
@endsection
