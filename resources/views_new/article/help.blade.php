                ...
                <div class="text_content">
                    ...
                    <div class="help_address">
                        ...
                        <div class="help_address_box">
                            <div class="help_addres_imgbox">
                                <img src="img/help_reg_add.png"/>
                            </div>
                            <div class="help_address_text">
                                <p>
                                    <span class="img_span"><img src="img/help_user_icon.png"/></span>
                                    <span class="help_left_span">收件人：</span>
                                    <span>兰秋菊</span>
                                </p>
                                <p>
                                    <span class="img_span"><img src="img/help_phone_icon.png"/></span>
                                    <span class="help_left_span">联系电话：</span>
                                    <span>028-69932957</span>
                                </p>
                                <p>
                                    <span class="img_span"><img src="img/help_address_icon.png"/></span>
                    ...
                    <div class="help_tishi">
                        ...
                        <ul class="help_tishi_list">
                            <li>1，注册时一定要记清楚用户名和密码，以便日后进行登录使用；1，注册时一定要记清楚用户名和密码，以便日后进行登录使用；</li>
                            <li>2，注册/购物时产生的所有个人信息，只用于您所在药易购购物时使用；我们通过严密的流程控制确保您个人的所有信息均不会被泄露或是作为其他用途被使用。</li>
                            <li>3，请您注册时填写真实的姓名、电话和详细地址；这样我们才能将您的货物准确送达。</li>
