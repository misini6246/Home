        ...
        <div class="container_box">
            <div class="top_title">
                ...
                <a href="{{route('index')}}">首页</a><img src="{{get_img_path('images/user/right_1_03.png')}}"
                        ...
                        src="{{get_img_path('images/user/right_1_03.png')}}" class="right_icon"/><span>红包变动记录</span>
            </div>
            @include('user.left')
            <div class="right">
                <div class="right_top">
                    <div class="right_top_title" style="width: 200px;">
                    ...
                    <table>
                        ...
                        @foreach($result as $v)
                            <tr>
                                ...
                                <td>@if($v->money>0)增加@else减少@endif</td>
                                <td class="zje">{{formated_price(abs($v->money))}}</td>
                        ...
                        @endforeach
                        <tr>
                            <td colspan="4" style="text-align: right;"><p style="font-size: 16px;color: #f52547;">
                                    您当前的可用红包为:{{formated_price(collect($user->hongbao_money)->get('money',0))}}</p></td>
                        </tr>
                    </table>
