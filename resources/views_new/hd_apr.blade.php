...
<body>
    ...
    <div class="list">
        ...
        @foreach($goods as $k=>$v)
            <li>
                <div class="left">
                    <a href="http://www.jyeyw.com/goods?id={{$v->goods_id}}" target="_blank"><img src="http://112.74.176.233/{{$v->goods_img}}" alt=""></a>
                </div>
                <div class="right">
                    <!-- 商品名 -->
                    ...
                    <p class="jg">
                        <!-- 活动价 -->
                        <span class="hdj"> <span>秒杀</span> ￥{{$v->promote_price}}</span>
                        <!-- 原价 -->
