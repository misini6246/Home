            ...
            @else
                <div class="g_right_bottom">
                    <p>抱歉, 没有找到
                        ...
                        @endif相关的药品,</p>
                    <p><a href="{{url('requirement')}}" target="_blank">点击这里提交求购意向，
                            {{config('services.web.name')}}网会尽快补货！</a></p>
                </div>
                <div class="g_right_bottom_bottom">
                    <p>没有找到你想要的药品？ <a href="{{url('requirement')}}"
                                      target="_blank">点击这里提交求购意向，{{config('services.web.name')}}网会尽快补货！</a></p>
                </div>
            @endif
