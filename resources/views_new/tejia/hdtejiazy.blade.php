...
@section('content')
    ...
    @include('common.nav')
    <div class="pingpaizq" style="background: url('{{$ad_img}}') no-repeat scroll top center;">
        <div class="center" style="position: relative;">
            ...
            {{--</div>--}}
            {{--</div>--}}
            <a target="_blank" href="/119yh/"
               style="display: inline-block;width: 100px;height: 32px;position: absolute;top:405px;right: 280px;"></a>
        </div>
    </div>
                ...
                @if(count($result)>0)
                    <div class="cart_tab" style="width: 1200px;">
                        <ul class="ul_box">
                            ...
                            {{--href="{{route('tejia',['step'=>$step,'type'=>$type])}}"><img--}}
                            ...
                            {{--<p>--}}
                            {{--<a title="{{$val}}"--}}
                            {{--href="{{route('tejia',['step'=>$step,'type'=>$type,'keywords'=>$val])}}">{{str_limit($val,32)}}</a>--}}
                            {{--</p>--}}
                            {{--@endforeach--}}
                            {{--<div class="quxiao">收起</div>--}}
                            {{--</div>--}}
                            {{--@endif--}}
                            {{--@endforeach--}}
                            {{--@endif--}}
                            ...
                            @foreach($result as $k=>$v)
                                <li class="child">
                                   ...
                                   @if($v->is_can_see==0) 会员可见 @else
                                            ...
                                            <li><span class="title mg">规格：</span>{{str_limit($v->spgg,24)}}</li>
                                            @if(!empty($v->xq))
                                            ...
                                            @endif
                                            <li>
                                                    <span class="title ll_1" title="{{$v->jzl}}"><span
                                                                class="mg">产地：</span>{{str_limit($v->jzl,14)}}</span>
                                                @if($step=='nextpro')
