...
@section('content')
    ...
    <div class="main fn_clear">
        ...
        <div class="main_right_box">
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 150px; float: right; height: 50px;">
                            <p style="line-height: 20px;"><a href="{{route('articleInfo',['id'=>91])}}" class="payonline_notice" target="_blank" style=" font-size: 14px; color: #39a817; display: inline; line-height: 25px; margin-right: 20px;">银联在线支付说明</a></p>
                            <p style="line-height: 20px;"><a href="{{route('articleInfo',['id'=>276])}}" class="payonline_notice" target="_blank" style="margin-right: 20px; display: inline;  font-size: 14px; color: #39a817; line-height: 20px;">农行在线支付说明</a></p></div>
            ...
            <table class="table2">
                <tr>
                    <th class="case1" colspan="6">商品列表</th>
                </tr>
                <tr class="title">
                ...
                @if($v->user_bz)
                <tr>
                    <td colspan="6" style="color:#F00; font-size:12px;" bgcolor="#ffffff" align="left">备注：{{$v->user_bz}}(下单数量：{{$v->goods_number_f or 0}})</td>
                </tr>
                @endif
                @endforeach
                <tr>
                    <td class="al_right com" colspan="6">
