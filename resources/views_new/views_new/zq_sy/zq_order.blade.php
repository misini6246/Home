...
@section('content')
    ...
    <div class="main fn_clear">
        ...
        <div class="main fn_clear">
            <div class="top">
                <span class="title">我的太星医药网</span> <a>>　<span>交易管理</span> </a> <a href="{{route('user.orderList')}}" class="end">>　<span>{{$pages_top}}</span></a> </div>
                ...
                <table id="se">
                    ...
                    <tr>
                        ...
                        <td class="result tb1_td6">
                            <a href="{{route('user.zq_order_info_sy',['id'=>$v->zq_id])}}" class="f6">查看订单</a>
                        </td>
                    </tr>
                    @endforeach
                    @else
