...
@section('content')
    ...
    <div class="main fn_clear">
        <div class="top"><span class="title">我的太星医药网</span> <a>>　<span>交易管理</span> </a> <a href="{{route('user.orderList')}}" class="end">>　<span>{{$pages_top}}</span></a> </div>
        @include('layout.user_menu')
        <div class="main_right_box">
            <div class="top_title">
                <h3 style="width: 200px;">{{$pages_top}}</h3>
                <span class="ico" style="left: 60px;"></span>
            </div>
            ...
            <table class="table1">
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 150px; float: right; height: 50px;line-height: normal;">
