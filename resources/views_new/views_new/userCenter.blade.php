    ...
    <div class="main fn_clear">
        ...
        <div class="main_mid">
            <ul class="fn_clear ul_list">
                <a href="{{route('user.account')}}" style="color: #666;"><li><span class="ico_com ico_1"></span>余额<p>{{formated_price($user->user_money)}}</p></li></a>
        ...
        @include('shuang11.userad',['user_ad'=>1])
        @else
            @include('shuang11.userad',['user_ad'=>0])
        @endif
    </div>
