    ...
    <div class="top_box">
        <div class="top">
            ...
            <div class="top_right">
                ...
                <a target="_blank" href="{{route('zhijian')}}">质检报告查询</a>|<a target="_blank"
                                                                             href="{{route('requirement.index')}}">求购专区</a>
        ...
        <div class="search">
            ...
            <div class="search-hot">
                ...
                @if($search_keywords)
                    ...
                    @if(time()<strtotime('20170330'))
                        @if(time()<strtotime('20170316'))
                        <a target="_blank"
                           href="@if(time()>strtotime('20170315')) {{route('category.index',['step'=>'promotion'])}} @else {{route('category.index',['step'=>'nextpro'])}} @endif"
                           style="color: red;">315特价活动
                        </a>
                        @endif
                        ...
                        <a target="_blank" href="http://www.hezongyy.com/jfdh" style="color: red;">积分兑券</a>
                    ...
                    @else
                        ...
                        {{--<a target="_blank" href="http://www.hezongyy.com/bt" style="color: red;">情人节抱团</a>--}}

                        {{--<a target="_blank" href="http://www.hezongyy.com/category?step=mysn&showi=0" style="color: red;">慢严舒柠特卖惠</a>--}}
                        <a target="_blank"
                           href="http://www.hezongyy.com/category?keywords=%E5%84%BF%E7%AB%A5%E9%80%80%E7%83%AD%E8%B4%B4&showi=0"
                           style="color: red;">儿童退热贴</a>
                        <a target="_blank" href="http://www.hezongyy.com/cxzq" style="color: red;">促销专区</a>
                        <a target="_blank" href="http://www.hezongyy.com/category?dis=7" style="color: red;">效期品种</a>
                    @endif
                    {{--@else--}}
