...
@section('links')
    ...
    <style type="text/css">
        ...
        .zhijisong-box ul.title-box li.title {
            width: 144px;
        ...
        .x-list {
            ...
            width: 702px;
            margin-bottom: 50px;
            background: url(http://images.hezongyy.com/images/sjz.png) 0px 22px no-repeat;
            border: 0;
        }
        ...
        .dingdanxixi li.checked {
            background: url(http://images.hezongyy.com/images/sjz-ico.png) 212px 19px no-repeat;
            background-color: #1b9a07;
        }

        .dingdanxixi li.checked h3, .dingdanxixi li.checked p {
            color: #feef02;
        }
...
@section('content')
    ...
    <div class="main fn_clear">
        ...
        <div class="main fn_clear">
            <div class="top">
                <span class="title">我的太星医药网</span> <a>>　<span>交易管理</span> </a> <a href="{{route('user.orderList')}}"
                                                                                class="end">>　<span>订单物流信息</span></a>
            </div>
                            ...
                            <div class="xinxi-box fn_clear" style="background-color:#f5f5f5">
                                @foreach($orders as $k=>$v)
                                    <div class="xinxi-list xx{{$k}}" @if($k==0)style="display:block;"@endif>
                                        ...
                                        <table class="x-list">
                                            @if($order->order_id==416848)
                                                <tr class="yqs">
                                                    <td style="border-bottom:0;width:30px;"><span class="dio"></span>
                                                    </td>
                                                    <td class="sj"><p
                                                                style="font-size:16px;">16:24:25</p>
                                            ...
                                            @foreach($v['steps'] as $val)
                                                <tr @if(strpos($val['acceptAddress'],'已签收')!==false&&$order->order_id!=416848)class="yqs"@endif>
                                                    <td style="border-bottom:0;width:30px;"><span class="dio"></span>
                                                    </td>
                                                    <td class="sj"><p
                                                                style="font-size:16px;">{{date('H:i:s',strtotime($val['acceptTime']))}}</p>
                                                        <p class="date">{{date('Y-m-d',strtotime($val['acceptTime']))}}</p>
                                                    </td>
