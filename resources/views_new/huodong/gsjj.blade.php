...
<head>
    <meta charset="utf-8">
    <title>公司简介-{{config('services.web.title')}}</title>
    <link rel="stylesheet" href="{{path('css/gsjj/jquery.fullPage.css')}}">
    <link href="{{path('css/gsjj/jianjie.css')}}1" type="text/css" rel="stylesheet" />
...
<div class="section section1">
    ...
    <div class="hgroup">
        <h1><a href="http://www.hezongyy.com/">{{config('services.web.name')}}网</a></h1>
        <h2>改变，不止所见。</h2>
    </div>
    <p class="p11"> 　　
...
<div class="section section8">
    ...
    <!-- <strong>[ 科技.聚 ]</strong> -->
    <h3></h3>
    <p class="p8"><img src="{{get_img_path('images/gsjj/section8_01.png')}}1" alt=""></p>
</div>
