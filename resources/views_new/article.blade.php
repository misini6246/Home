...
<!--/头部-->
    ...
    <div class="top-box">
        <div class="box-container">
            ...
            <div class="option">
                <div  class="option-item @if($cat_id==2) cur @endif"><a href="/articleInfo?id=9">新人指南</a></div>
                <div  class="option-item @if($cat_id==6) cur @endif"><a href="/articleInfo?id=12">配送方式</a></div>
