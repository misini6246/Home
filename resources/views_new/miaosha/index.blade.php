...
@section('links')
    <style>
        ...
        #miaosha-bottom {
            width: 100%;
            height: 534px;
            background: #e74320 url('{{get_img_path('images/miaosha/170808/pcmiaosha-2.jpg')}}') no-repeat scroll top center;
            min-width: 1200px;
            max-width: 1920px;
            margin: 0 auto;
        }
    ...
    <div id="miaosha-bottom">
        <div class="chanpin-box">
            @foreach($team[0]->goods as $k=>$v)
                <div class="ct-{{$k+1}}"
                     style=" @if($k>0) margin-left:20px; @endif background: url('{{get_img_path('images/miaosha/170808/pc-'.$v->goods_id.'.jpg')}}') no-repeat scroll top center;">
                    <div class="kucun">
