...
@section('links')
    <style>
        ...
        #miaosha-top {
            width: 100%;
            height: 615px;
            background: url('{{get_img_path('images/miaosha/171109/pcmiaosha-11.jpg')}}') no-repeat scroll top center;
            min-width: 1200px;
            max-width: 1920px;
            margin: 0 auto;
            overflow: hidden;
        ...
        .second {
            ...
            position: relative;
            top: 2px;
            background: url('{{get_img_path('images/miaosha/171109/time_box.png')}}') no-repeat;
        }
        ...
        #miaosha-top .time {
            ...
            position: relative;
            background: url('{{get_img_path('images/miaosha/171109/time_bg.jpg')}}') no-repeat;
        }
        ...
        .sp_box li .sp .text .guige {
            color: #996027;
            border-bottom: 1px solid #996027;
            height: 34px;
            line-height: 34px;
            margin-top: 0;
        }
        ...
        .now_check .sj {
            color: #fd333c !important;
        }

        #miaosha-top .time li.over .zt {
            color: #999999;
...
@section('content')
    ...
    <div id="miaosha-top">
        ...
        <div class="remaitime">
            ...
            <div class="daojishi" style="font-size: 20px;">
                <span class="now_time">00:00</span>
