...
@section('links')
    ...
    <style type="text/css">
        ...
        .pingpai-box .pingpai-list {
            width: 1200px;
            margin: 0 auto;
            overflow: hidden;
        }

        .pingpai-box .pingpai-list ul {
            width: 1400px;
        }

        .pingpai-box .pingpai-list ul li {
            position: relative;
            width: 260px;
            height: 375px;
            float: left;
        ...
        .pingpai-box .pingpai-list ul li img {
            width: 260px;
            height: 375px;
        }
        ...
        .initial a:hover, .initial a.checked_a {
...
@section('content')
    ...
    @if($ad117)
        <div class="pingpaizq"
             style="background: url('{{$ad117->ad_code}}') no-repeat scroll center top;height: 400px;min-width: 1200px;overflow: hidden;width: 100%;">
    ...
    <div class="search-box">
        <div style="height:55px;margin-top:25px;position: relative;" class="fn_clear">
            ...
            <div id="list_wrap" class="search_show list_box suggestions_wrap"
                 style="display: none;left: 98px;top: 35px;width: 294px;border: 1px solid #e5e5e5">
        ...
        <div class="pingpai-list">
            @if(count($pages)>0)
                <ul class="list-first fn_clear">
                    @foreach($pages as $v)
                        <li>
                            <a href="@if(!empty($v->url)) {{$v->url}} @else {{route('category.index',['step'=>$v->rec_id,'showi'=>0])}} @endif"
                               target="_blank"><img src="{{$v->img}}" alt=""/></a>
                        </li>
                    @endforeach
                </ul>
