        ...
        <div class="box_1">
            ...
            <div class="boxCenterList RelaArticle" align="center">
                <div style="margin:20px auto; width:550px; text-align:left;">
                    <p style="font-size: 14px;"><font style="font-size: 14px; font-weight:bold; color: red;"></font>,请按照如下要求将相关资质材料邮寄给我们进行认证！</p>
                    ...
                    <p><a style="font-size:14px;font-weight:bold;color:#FF6600;" href="/uploads/{{date('Y')}}采购委托书模板.doc">{{date('Y')}}采购委托书模板下载</a>　<a style="font-size:14px;font-weight:bold;color:#FF6600;" href="/uploads/购买特殊管理药品委托书格式.doc">购买特殊管理药品委托书格式下载</a></p>
                    <p style="font-size: 14px; font-weight:bold">邮寄地址：成都市金牛区友联一街18号（量力医药健康城8号楼）13-14层</p>
