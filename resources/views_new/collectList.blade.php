            ...
            <div  class="content_box"  >
                ...
                <table class="gwc_tb2">
                    ...
                    <tr id="{{$v->goods_id}}" data-id="{{$v->goods_id}}-1">
                        ...
                        <td class="tb2_td2"><a href="{{route('goods.index',['id'=>$v->goods_id])}}"><img class="fly_img{{$v->goods_id}}" src="{{$v->goods_thumb}}" alt="{{$v->goods_name}}" title="{{$v->goods_name}}"/></a> <p class="name">{{str_limit($v->goods_name,10)}}</p></td>
                        ...
                        <td class="tb2_td8">
                            <a href="javascript:@if($v->is_can_buy==1) addToCart1({{$v->goods_id}},1)@else addToCart2({{$v->goods_id}}) @endif" class="cart fly_to_cart{{$v->goods_id}}"><img title="加入购物车" src="{{path('images/shopping_cart1.jpg')}}"></a>
