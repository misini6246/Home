...
@section('content')
    ...
    <div id="container-tg" style="background-color: #3eb4fa;">
        <div class="container-box" style="height: 100%">
            ...
            <div id="zq" style="height: 300px;">
                <div class="zq-content">
                    <ul>
                        <li style="background: url('{{get_img_path('images/tegong/tgzq1.png')}}');">
                            <a target="_blank" href="/goods?id=30574" class="tg-btn-left"></a>
                            <a target="_blank" href="/goods?id=30574" class="img-btn-left"></a>
                        </li>
                        <li style="background: url('{{get_img_path('images/tegong/tgzq2.png')}}');">
                            <a target="_blank" href="/goods?id=30189" class="tg-btn-right"></a>
                            <a target="_blank" href="/goods?id=30189" class="img-btn-right"></a>
                        </li>
                    </ul>
                </div>

            </div>
            <div id="zq" style="padding-top: 0">
