...
<div class="title_list_box">
    <ul class="title_list">
        ...
        <li>
            {{-- <a href="#youhui">优惠专区</a> --}}
            <a href="#youhui">折扣专区</a>
        </li>
        <li>
            <a href="#tejia">特价专区</a>
        </li>
    ...
    <div class="container_box">
        <div class="cxzq_section" id="mzjx">
            ...
            <ul class="mzjx_list">
                ...
                <li>
                    @if($v->shop_price==$v->promote_price)
                    <div class="tejia layer_tips" style="background: #418ed2">满减</div>
                    @endif
                    <div class="img_box">
                        <a target="_blank" href="{{$v->ad_link}}"><img src="{{get_img_path($v->goods_thumb)}}" /></a>
                    </div>
                    <div class="text">
                        ...
                        <div class="btn">
                            ...
                            <a target="_blank" href="{{$v->ad_link}}">立即购买</a>
                        </div>
                    </div>
                </li>
                @endforeach
        ...
        <div id="jpmz" class="cxzq_section">
            ...
            <ul class="czhg_list">
                ...
                <li>
                    ...
                    <div class="hd">
                        <div class="fl">活动</div>
                        <div class="fr layer_tips" data-msg="{{$v->cxxx}}" id="{{$v->goods_id}}">{{$v->cxxx}}</div>
                    </div>
                    @endif
                    <div class="btn">
                        <div class="fl">
...
<div id="bgcolor_1" class="container">
    <div class="container_box">
        <div id="youhui" class="cxzq_section">
            <div class="section_title">
                <img src="/index/img/cxzq_title.png" />
                {{-- <span>优惠专区</span> --}}
                <span>折扣专区</span>
            ...
            @if(!empty($youhui))
            <div class="readmore">
                <a target="_blank" href="/cxhd/youhui">点击查看更多</a>
            </div>
            @else
            <div class="readmore">
                <a target="_blank">敬请期待</a>
