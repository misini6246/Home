...
@section('content')
    <div id="data">
        <div style="position: relative;" id="img1">
            <img src="{{get_img_path('images/hd/1109/8000bg.jpg')}}">
        </div>
        <div class="bang bang-right word" data-sx3="595">
        ...
        <div class="time word" data-sx3="620">
        ...
        <div class="money word" data-sx3="740">
        ...
        <div class="tiao word" data-sx3="877">
