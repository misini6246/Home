...
<link rel="stylesheet" href="/huodong/201907/css/hd_1907.css">
...
<div class="container">
    <div class="content">
        ...
        <div class="coupon-box">
            <div class="title">
                <img src="/huodong/201907/img/title1.png">
            </div>
            <div class="coupons">
                <div class="newer-coupon" style="text-align:center;padding-top:90px">
                    <a target="_blank" href="/yhq">
                        <img src="/huodong/201907/img/coupons/66.png" alt="">
                    </a>
                </div>
                @for ($i = 1; $i < 10; $i++) 
                    @if ($i==7||$i==9)
                    <div class="coupon">
                        <img src="/huodong/201907/img/coupons/coupon{{$i}}.png">
                    </div>
                    @else
                    <div class="coupon">
                        @if($i==8)
                        <img coupon-id="146" class="can-click" src="/huodong/201907/img/coupons/coupon{{$i}}.png">
                        @else
                        <img coupon-id="{{153-$i}}" class="can-click" src="/huodong/201907/img/coupons/coupon{{$i}}.png">
                        @endif
                    </div>
                    @endif
                @endfor
            ...
            <li>
                ...
                <div class="right">
                    ...
                    <p class="jg">
                        ...
                        @else
                        <!-- 原价 -->
                        <span class="yj" style="margin-left:0">原价:<span>￥{{$v->shop_price}}
                            </span></span>
                        @endif
                    </p>
                    <!-- 库存 -->
                    ...
                    <div class="btn-box">
                        ...
                        <div class="add-cart" data-img="{{$v->goods_thumb}}" >
                            <img src="/huodong/april/img/cart.png" /> 活动未开始
                        </div>
                        @elseif($v->promote_end_date<time())    
                        <div class="add-cart" data-img="{{$v->goods_thumb}}" >
                            <img src="/huodong/april/img/cart.png" /> 活动已结束
                        </div>                        
                        @else
