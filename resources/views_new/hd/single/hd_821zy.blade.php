...
<link rel="stylesheet" href="/huodong/20190821/css/hd821.css">
...
<div class="container">
    <div class="content">
        <img src="http://www.jyeyw.com/huodong/20190821/img/banner.jpg" alt="">
    </div>
    <div class="list">
        <ul class="clear-float">
            ...
            <li class="clear-float">
                ...
                <div class="goods-info">
                    ...
                    <p class="dw">单位：{{$v->goods_attribute->bzdw}}</p>
                    <p class="cd">产地：{{$v->goods_attribute->jzl}}</p>
