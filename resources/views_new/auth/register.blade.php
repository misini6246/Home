...
<html>
	...
	<head>
		...
		<script src="/register/register.js" type="text/javascript" charset="utf-8"></script>
	</head>
				...
				<div class="content-container clear_float">
					...
					<form id="register" action="{{url('auth/register')}}" method="post">
						...
						<div class="choose_address fn_clear">
							...
							<div class="select choose_select province" style="margin-left: 0px;">
								...
								<ul class="select_options">
									...
									@foreach(\App\Region::where('region_type',1)->orderBy('agency_id','desc')->get() as $v)
							...
							<span class="prompt margin_problem" style="margin-left: -1px">*</span>
						...
						<label class="agree">
			                ...
			                我已看过并接受<a href="/articleInfo?id=19" target="_blank">《用户协议》</a> </label>

						<a href="javascript:;" id="submit"> 注册
						</a>
...
<script>
    $(function(){
        $('.header_reg_log .left span').text('注册页面')
    })
</script>