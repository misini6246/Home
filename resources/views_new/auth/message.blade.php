...
<head>
    ...
    <style type="text/css">
        .block_1{height:auto;width: 1200px;margin: 30px auto; box-shadow: 0 0 10px rgb(179,177,178);border: 1px solid #e5e5e5;overflow: hidden ;line-height:30px;font-size: 12px}
        ...
        <div class="box_1">
            ...
            <div class="boxCenterList RelaArticle" align="center">
                <div style="margin:20px auto; width:550px; text-align:left;">
                    ...
                    <p><a style="font-size:14px;font-weight:bold;color:#FF6600;" href="/uploads/采购委托书模板.doc">采购委托书模板下载</a>　<a style="font-size:14px;font-weight:bold;color:#FF6600;" href="/uploads/购买特殊管理药品委托书格式.doc">购买特殊管理药品委托书格式下载</a></p>
                    <p style="font-size: 14px; font-weight:bold">邮寄地址：重庆市南岸区长电一支路2号，重庆今瑜医药股份有限公司</p>
                    <p style="font-size: 14px; font-weight:bold">收件人：鞠娟&nbsp;&nbsp;&nbsp;&nbsp;电话：023-81392701  &nbsp;手机:13637912248 &nbsp;&nbsp;&nbsp;&nbsp;</p>
                    <p style="text-align:center">
                        <a href="{{route('index')}}">返回首页</a>&nbsp;&nbsp;
                        <a href="http://47.107.103.86/member">前往会员中心</a>&nbsp;&nbsp;
                    </p>
                </div>
            </div>
        </div>
...
<script>
    $(function(){
        $('.header_reg_log .left span').text('注册成功')
    })
</script>
