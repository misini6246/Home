...
@if(Auth::check())
<p>&nbsp;&nbsp;<font style="color:#F95706;">{{Auth::user()->user_name}}</font>，欢迎来您到{{config('services.web.name')}}网积分商城！<a href="/auth/logout">[退出]</a></p>
<div class="page_nav">
...
@else
    <p>&nbsp;&nbsp;{{config('services.web.name')}}网积分商城欢迎您！</p>
    <div class="page_nav">
        <ul class="clear_float">
