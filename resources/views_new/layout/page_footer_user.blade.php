...
<div class="footer fn_clear">
    ...
    <div class="footer_bottom">
        ...
        <div class="title">
            {{--<a href="{{path('images/zgz1.jpg')}}" target='_blank'>互联网药品交易服务资格证：川B20130002 </a>|--}}
            <a href="{{path('images/zgz2.jpg')}}" target='_blank'>互联网药品信息服务资格证：川20160010</a>
        </div>
        <div class="title"><a href="http://www.hezongyy.com/" target="_blank">版权所有 {{date('Y')}}{{config('services.web.name')}} www.hezongyy.com </a>ICP备案证书号:蜀ICP备18023478号-1</div>
        <div class="title">
