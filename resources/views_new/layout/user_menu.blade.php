<div class="main_left fn_clear">
    ...
    <div class="list">
        ...
        <ul class="list_fist">
            ...
            @endif
            <li><a href="{{route('jifen.order')}}">积分订单 <span class="right_ico"></span></a></li>
        ...
        <h3 class="xiaoxi" style="text-indent: 0;"><img style="margin-right: 7px;"
                                                        src="{{get_img_path('images/xiaoxi.jpg')}}"/> 消息中心</h3>
        <ul class="list_fist">
            <li @if($action=='znx')class="li_checked"@endif ><a href="{{route('user.znx_list')}}">我的消息@if(msg_count()>0)
                        ({{msg_count()}})@endif <span
                            class="right_ico"></span></a></li>
        </ul>
        ...
        <ul>
            ...
            <li @if($action=='account')class="li_checked"@endif ><a href="{{route('user.accountInfo')}}">余额管理 <span
                            class="right_ico"></span></a></li>
            <li @if($action=='mobile_login')class="li_checked"@endif ><a href="{{route('user.mobile_login')}}">切换会员
                    <span
                            class="right_ico"></span></a></li>
            ...
            @if($user->is_zq==1||$user->is_zq==2)
                <li @if($action=='zq_log')class="li_checked"@endif ><a href="{{route('user.zq_log')}}">账期记录 <span
                                class="right_ico"></span></a></li>
            @endif
            <li><a href="{{route('jifen.user.index')}}">积分管理 <span class="right_ico"></span></a></li>
