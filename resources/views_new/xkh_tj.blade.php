...
@section('content')
    ...
    <div class="site-content-box" style="width: 1200px;margin: 0 auto;">
        ...
        <div class="site-first">
            ...
            <div class="good-list" style="margin-top: 20px;width: 1200px;overflow: hidden;">
                <div class="title" style="width:290px;height:94px;margin:0 auto 30px auto;"><img
                            src="{{get_img_path('images/shang12010.jpg')}}" alt=""></div>
                    ...
                    @foreach($goods_list as $k=>$v)
                        <li>
                            <div class="li-box">
                                ...
                                <h4>{{str_limit($v->goods_name,26)}}</h4>
                                <p>{{str_limit($v->sccj,34)}}</p>
                                <p>规格：{{$v->spgg}}</p>
                                <div class="fn_clear" style="height: 24px;line-height: 24px;">
                                    <p style="width: 45%;float: left;">件装量：{{$v->jzl or ''}}</p>
                                    <p style="width: 55%;float: left;@if($v->is_xq_red==1) color:#e70000; @endif">
                                        效期：{{$v->xq}}</p>
                                </div>
                                ...
                                <div class="fn_clear" style="height: 24px;line-height: 24px;">
                                    <p style="width: 45%;float: left;">库存：@if($v->goods_number>800)
                                            充裕@elseif($v->goods_number==0)缺货@else{{$v->goods_number}}@endif </p>
                                    <p style="width: 55%;float: left;"> 中包装：{{$v->zbz or 1}}</p>
                                </div>

                                <div class="btn">
                                    <input class="num ls_num" id="J_dgoods_num_{{$v->goods_id}}" name="number"
                                           type="text" value="@if($v->ls_gg>0){{$v->ls_gg}}@else{{$v->zbz or 1}}@endif"
                                           defaultnumber="@if($v->ls_gg>0){{$v->ls_gg}}@else{{$v->zbz or 1}}@endif"
                                           onblur="changePrice({{$v->goods_id}})" data-zbz="{{$v->zbz or 1}}"
        ...
        <div><img src="{{get_img_path('adimages1/201809/erji/xrtj1.jpg')}}"></div>
        <div class="bottom-box">
            <div class="l-box" style="width:582px;height:390px;float:left;margin-left:10px;"><a target="_blank"
                                                                                                href="/jifen"><img
                            src="{{get_img_path('adimages1/201809/erji/xrtj2.jpg')}}" alt=""></a></div>
            <div class="r-box" style="width:582px;height:390px;float:left;margin-left:20px;"><img
                        src="{{get_img_path('adimages1/201809/erji/xrtj3.jpg')}}" alt=""></div>
    ...
    <div class="footer-box" style="width:100%;height:500px;background-color:#2897d0;">
        <div class="footer" style="width:1200px;margin:0 auto;">
            <ul style="width:870px;margin:0 auto" class="cc fn_clear">
                <li><a target="_blank" href="{{route('index')}}#mzjx"><img
                                src="{{get_img_path('images/shang12014.jpg')}}" alt=""></a></li>
                <li><a target="_blank" href="/cxhd/czhg"><img src="{{get_img_path('images/shang12015.jpg')}}"
                                                              alt=""></a></li>
                <li><a target="_blank" href="{{$mydc or route('index')}}"><img
                                src="{{get_img_path('images/shang12016.jpg')}}" alt=""></a></li>
            </ul>

            <ul style="width:760px;margin:0 auto" class="sm fn_clear">
                <li><img src="{{get_img_path('images/shang12017.jpg')}}" alt=""></li>
                <li><img src="{{get_img_path('adimages1/201807/erji/shang12018.jpg')}}" alt=""></li>
