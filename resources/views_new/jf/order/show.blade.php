...
@section('links')
    ...
    <link href="{{path('css/jf/dingdanxiangqing.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <div class="container content">
        <div class="content_box">
            <div class="top_title">
                ...
                <span>当前位置：<a href="{{route('jf.index')}}">积分首页</a> > <a href="{{route('jf.user.index')}}">个人中心</a>> 订单详情</span>
            </div>
            <div class="vip">
