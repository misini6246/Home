...
class UserAddressController extends Controller
{
    ...
    {
        $this->action = 'user';
        $result       = UserAddress::where('user_id', $this->user->user_id)->orderBy('is_default', 'desc')->get();
        $this->set_assign('result', $result);
        $this->set_assign('user_menu', 'address');
        $this->set_assign('wntj', $this->getTj8());
        $this->common_value();
        return view('jf.address.index', $this->assign);
    }
    ...
    public function create()
    {
        ...
        return view('jf.address.create', $this->assign);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (count($user_address) >= 5) {
            ...
            $content  = response()->view('jf.layouts.address', ['address' => $user_address])->getContent();
            $qian     = array("\t", "\n", "\r");
    ...
    public function edit($id)
    {
        ...
        return view('jf.address.edit', $this->assign);
    }
